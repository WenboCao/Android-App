...
if (!empty($_POST)) {
    ...
    if (empty($_POST['username']) || empty($_POST['useremail'])) {
        ...
        $response["success"] = 0;
        $response["message"] = "Please Enter Both a name and Email.";
...
$query        = " SELECT 1 FROM users WHERE useremail = :email";
    ...
    $query = "INSERT INTO users ( username, useremail, userprofession, userlocation, userchoice ) VALUES ( :user, :email, :profession, :location, :choice ) ";
...
?>
    ...
    <form action="register.php" method="post"> 
        ...
        <br /><br /> 
        UserProfession:<br /> 
        <input type="text" name="userprofession" value="" /> 
        <br /><br /> 
        UserLocation:<br /> 
        <input type="text" name="userlocation" value="" /> 
        <br /><br /> 
        UserChoice:<br /> 
        <input type="text" name="userchoice" value="" /> 
        <br /><br /> 
